...
// 用来测试 VRF 配合 consumer 能否正常工作
// 部署 mock VRF + consumer 、附带订阅操作

const VrfWithConsumerModule = buildModule("VrfWithConsumerModule", (m) => {
  ...
  const fundAmount = parseEther("100") // 100 LINK。mock 中消耗的是 link
...
export default VrfWithConsumerModule
